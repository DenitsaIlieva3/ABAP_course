CLASS zcl_denitsaa_date_parsing DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_denitsaa_date_parsing IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
  DATA: lo_dateparsing TYPE REF TO zcl_denitsaa_date_parsing,
        lv_result      TYPE dats.

  lo_dateparsing = NEW zcl_denitsaa_date_parsing( ).
